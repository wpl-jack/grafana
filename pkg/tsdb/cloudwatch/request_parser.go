...
func migrateStatisticsToStatistic(queryJson *Query) error {
...
func migrateAliasToDynamicLabel(queryJson *Query) {
	fullAliasField := ""
...
func parseRequestQuery(model Query, refId string, startTime time.Time, endTime time.Time) (*cloudWatchQuery, error) {
...
func parseDimensions(model Query) (map[string][]string, error) {
